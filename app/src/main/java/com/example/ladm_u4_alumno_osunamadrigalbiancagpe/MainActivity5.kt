...
class MainActivity5 : AppCompatActivity(), DevicesRecyclerViewAdapter.ItemClickListener,
    ...
    private fun startDiscovery() {
        ...
        if (mBtAdapter?.isDiscovering ?: false) {
            ...
            AlertDialog.Builder(this).setMessage("DETENIDO")
        }
                ...
                Constants.MESSAGE_STATE_CHANGE -> {
                    ...
                    when (msg.arg1) {
                        ...
                        BluetoothChatService.STATE_CONNECTED -> {
                            ...
                            Snackbar.make(findViewById(R.id.mainScreen),"Connected to " + mConnectedDeviceName,
                        ...
                        BluetoothChatService.STATE_LISTEN, BluetoothChatService.STATE_NONE -> {
                            ...
                            Snackbar.make(findViewById(R.id.mainScreen),getString(R.string.not_connected),
                                Snackbar.LENGTH_SHORT).show()
                            connected = false
                        }
                    }
